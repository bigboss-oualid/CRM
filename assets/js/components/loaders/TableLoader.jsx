...
const TableRow = props => {
    ...
    return (
        <ContentLoader
            ...
            {...props}
        >
            <rect x="4" y="15" rx="4" ry="4" width="40" height="6.4"/>
            <rect x="60" y="13" rx="6" ry="6" width={320 * random} height="12"/>
            <rect x="366" y="13" rx="6" ry="6" width={250 * random} height="12"/>
            <rect x="610" y="13" rx="6" ry="6" width={150 * random} height="12"/>
            <rect x="770" y="13" rx="6" ry="6" width={600 * random} height="12"/>
            {/*
